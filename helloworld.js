//
// helloworld.js
// Summary : template-helloworld.js used to generate helloworld.js.
// Icon : helloworld.jpg
//

var ManVer = "1438268081025";
function GetManVer()
{
    return ManVer;
...
var strFileURL = "http://snapback-apps.com/helloworld/helloworld1438268081025.cdpupdate";
...
var strOnlineURL = "http://snapback-apps.com/helloworld/invis.gif";
...
var SyncCookieName = "helloworldpckgid";
...
var ManifestFile = "helloworld.xml"
...
var ManifestURL_Remote = "http://snapback-apps.com/helloworld/helloworld.xml";
...
var ManifestURL_Local = "%ALLUSERSPROFILE%\\cdp\\snapback\\apps\\helloworld\\helloworld.xml";
...
var StartUrl_Remote = "http://snapback-apps.com/helloworld/index.html";
...
function switchToLocal()
{
    ...
    {
        output = doCommand2( "takemelocal" + "," + "\"" + escape("%ALLUSERSPROFILE%\\cdp\\helloworld\\startmom.vbs") + "\"" );
    }
