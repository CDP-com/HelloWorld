...
function chattest()
{
   ...
   // window.open( "http://factory.snapback-apps.com/wordpress/wp-content/plugins/autologin-guest/autologin.php?redirect_to=http://one-click.cdp.com/wordpress/rw/wp-admin/post.php%3Fpost=12%26action=view", "", "height=400,width=700,toolbar=yes,scrollbars=yes,resizable=yes" );
}
